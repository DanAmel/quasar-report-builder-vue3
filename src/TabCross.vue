            ...
            <q-item v-for="(item, index) in newFilter.column_cross" v-bind:key="index">
              <q-item-section dense>
                <ColumnCross
                  ...
                  :index="index"
                  :validator="validator.newFilter.column_cross.$each.$response.$data"
                  :icon-type="iconType"
          ...
          <q-item v-for="(item, index) in newFilter.line_cross" v-bind:key="index">
            <q-item-section dense>
              <LineCross
                ...
                :index="index"
                :validator="validator.newFilter.line_cross.$each.$response.$data"
                :icon-type="iconType"
                :available-columns="availableColumns"/>
            </q-item-section>
          </q-item>
          ...
          <q-item v-for="(item, index) in newFilter.value_cross" v-bind:key="index">
            <q-item-section dense>
              <ValueCross
                ...
                :index="index"
                :validator="validator.newFilter.value_cross.$each.$response.$data"
                :icon-type="iconType"
                :available-columns="availableColumns"/>
            </q-item-section>
          </q-item>
...
export default {
  name: 'TabCross',
  components: {
    ColumnCross: defineAsyncComponent(() => import('./ColumnCross.vue')),
    LineCross: defineAsyncComponent(() => import('./LineCross.vue')),
    ValueCross: defineAsyncComponent(() => import('./ValueCross.vue'))
  },
  mixins: [],
  props: {
