<template>
  ...
  <div class="row">
    ...
    <div class="col-1"> <q-select  dense outlined class="q-mr-md"
                                   ...
                                   :options-dense="true"
                                   :@m-blur="validator[index].condition.$touch"
                                   :error="validator[index].condition.$error"
    > </q-select> </div>
    ...
    <div class="col-4"> <q-select  dense outlined class="q-mr-md"
                                   ...
                                   :@m-blur="validator[index].column.$touch"
                                   :error="validator[index].column.$error"
                                   @input="resetByColumn"
    ...
    <div class="col-2"> <q-select  dense outlined class="q-mr-md q-mb-lg"
                                   ...
                                   option-label="name" option-value="code"
                                   :options-dense="true"
                                   :@m-blur="validator[index].operand.$touch"
                                   :error="validator[index].operand.$error"
    ...
    <div class="col-1">
      <q-checkbox  class="q-mt-lg" dense v-model="item.use_variable" label="" left-label >
        <q-tooltip>Comparez a une 2eme variable </q-tooltip>
      </q-checkbox>
    </div>
    <div class="col-3">

      <span v-if="!item.use_variable">
        <q-input v-if="!hasData"  v-model="item.value" :type="getInputValue" dense label="Valeur" filled
      ...
      <span v-if="item.use_variable">
        <q-select  dense outlined class="q-mr-md"
                   ...
                   use-input input-debounce="0"
                   @filter="filterAvailableColumns"
                   :@m-blur="validator[index].column_attribut.$touch"
                   :error="validator[index].column_attribut.$error"
                   @input="resetByColumn"
