        ...
        <q-dialog
          ...
          <q-card class="my-card">
            ...
            <q-card-section style="position: relative">
              ...
              <div class="row no-wrap q-pt-md q-pl-md">
                ...
                <div class="col-md-5">
                  <q-select dense outlined class="q-mr-md"
                            ...
                            @m-blur="v$.mReport.$touch"
                            :error="v$.mReport.$error"
              ...
              <div class="row no-wrap q-pa-md">
                <div class="col-md-10">
                      <span class="text-h7 col-md-8"><q-input v-if="newFilter" class="q-mr-md" dense label="Titre" filled
                                                              @m-blur="v$.newFilter.title.$touch"
                                                              :error="v$.newFilter.title.$error"
                                                              v-model="newFilter.title"/></span>
                </div>
                <div class="col-md-2">
...
export default {
  ...
  components: {
    //TabData,
    TabData: defineAsyncComponent(() =>  import('./TabData') ),
    TabCross: defineAsyncComponent(() =>  import('./TabCross') ),
    TabChart: defineAsyncComponent(() =>  import('./TabChart') ),
  },
  emits: ['update:modelValue', "reloadPage", "showNotification", "showPreview"],
          ...
          $each: helpers.forEach({
            ...
            column_attribut: {
              required: requiredIf(function (model) {
                //todo requiredIf  la variable use_variable est a true
                return !!model
              })
            },
          })
  ...
  methods: {
    ...
    /*
     * Génère un objet qui va etre utilisé par le composant parent Generator.vue pour l'affichage de rapports etc..
     */
    generateFilter() {
    ...
    addSQLConfig() {
      ...
      this.$q.dialog({
        ...
        //Click ok
        console.log("clik ok parent ", val)
    ...
    change() {
      ...
      this.$emit('update:modelValue', clone(val))
    },
