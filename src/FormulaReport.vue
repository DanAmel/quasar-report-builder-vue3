  ...
  <div class="row">
    ...
    <div class="col-5">
      ...
      <q-input
        ...
        class="q-ml-md"
        :@m-blur="validator[index].expression.$touch"
        :error="validator[index].expression.$error"
    ...
    <div class="col-5 justify-start">
      <q-input
        ...
        v-model="item.alias"
        class="q-ml-md"
        :@m-blur="validator[index].alias.$touch"
        :error="validator[index].alias.$error"
        dense label="Libellé" />
    </div>
    ...
    <div class="col-1">
      ...
      <q-icon
      :aria-errormessage="validator[index].variables.$error" v-if="variables.length>0" class="q-mx-xs q-mt-md" color="black" size="25px" :name="iconType+'exclamation-circle'" @click="addVariables" >
        <q-tooltip>
